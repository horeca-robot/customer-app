...
public class ProductController {
    ...
    public ArrayList<Category> getCategories(){
        ...
        formaggio.add((new Ingredient(100,"Tomaat")));
        ...
        Category preCategory = new Category(1,"Voorgerecht", "https://www.24kitchen.nl/files/styles/social_media_share/public/2020-08/verse-tomatensoep.jpg?itok=AqWg5Ju0");
        ...
        Category mainCategory = new Category(2,"Hoofdgerecht","https://pizzametpazzi.nl/wp-content/uploads/2017/02/pizzamargherita_orig-600x400.jpeg");
    ...
    public Product getProductById(@RequestParam int categoryId, @RequestParam int productId){
        ArrayList<Ingredient> margherita = new ArrayList<>();
        margherita.add((new Ingredient(1,"Tomaat")));
        margherita.add((new Ingredient(2,"Mozzarella")));
